...
# Armstrong 2018 is missing (from our pdfs) - fixed 5/1/2023
...
# Reading_IDs (missing from index) for 2004_Moller_et_Al co-management.pdf, 2006 Adelzadeh Thesis Co-management.pdf, 2008_Adeel et al_review traditional water management drylands.pdf, 2010_Donohue_et_al co-management.pdf, 2010_Lertzman.pdf, 2011_Stumpff co-management.pdf, 2018_Middleton-Manning_et_al.pdf, 2020_EmanuelandWilkens co-management.pdf, 2022_Ramos.pdf - all from the "recent uploads" folder

Reading_ID <- c(11,15,49,22,84,23,3,4,9,16,45,47,5,6,58,12,65,NA,24,10,NA,25,62,17,NA,69,71,26,52,18,NA,NA,1,NA,27,41,31,72,7,63,20,46,40,74,78,73,75,8,79,59,19,42,76,80,85,66,28, 86,81,33,34,29,57,53,77,64,67,NA,48,30,68,37,55,90,2,88,87,NA,13,82,43,60,83,35,36,89,70,56,32,38,54,NA,39,61,14,50,44,51,21) # Armstrong 2018 is 14
...
# final metadata
metadata <- merge(index, new_IDS, by = "Reading_ID", all = TRUE) # because of duplication in "pdf", must use "Reading_ID"

write.csv(metadata, "Data/clean_meta_data.csv", row.names = FALSE)
